...
function Contact(){
    return(
        <Container align="center" maxWidth="xl">
            <Avatar sx={{ width: 150, height: 150 }} alt="Philip Axelsson" src={philip}/>
            ...
            <Typography variant="p" sx={{
                ...
                I'm always interested in meeting new people and staying connected.<br/>
                Feel free to send me an email if you want to take a java together and plan the future.
            </Typography>
